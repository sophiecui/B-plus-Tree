...
enum NODE_TYPE {
    NODE_TYPE_ROOT     = 1,    // represent root
    NODE_TYPE_INTERNAL = 2,    // represent internal node
    NODE_TYPE_LEAF     = 3,    // represent leaf node
};
...
public:
    ...
    virtual BTNode* getPointer(int i) {return NULL;}
    virtual void setPointer(int i, BTNode* pointer) {}
